...
export default class FeatureArtGallery extends Feature
{
    constructor(realm)
    {
        super(realm)
        this.piecesCount = 12
        this.room = new FeatureRoom(realm.conjure, realm.group, { roomWidth: this.piecesCount * 2 })
    ...
    createPainting(pos)
    {
        ...
        let mesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2), new THREE.MeshBasicMaterial({ map:texture, side:THREE.DoubleSide }))
